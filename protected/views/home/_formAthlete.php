...
?>
	...
	<div class="col-sm-3">
            <?php
            $SchoolList1 = CHtml::listData( Athlete::model()->findAll(), 'id','lname');
...
<?php $this->endWidget(); ?>
<?php
	$schoolSave = Yii::app()->createUrl( "Home/AthleteSave" );
   ...
   Yii::app()->clientScript->registerScript('script_event', "
	...
	function saveExpenses()
	{
		$.ajax({
	        type        : 'POST',
	        url         : '{$schoolSave}',
	        data        : $('#season_athlete_form').serialize(),
	        cache       : false,
